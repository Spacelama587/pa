...
const ZPatternSection = () => {
  return (
    <div className="container mx-auto py-28 h-full">
      ...
      <div className="flex flex-col md:flex-row items-center bg-gradient-to-r from-blue-300 to-sky-400">
        <div className="w-full md:w-1/2 p-4">
          <div className="rounded-lg overflow-hidden h-96 md:h-[30rem]">
      ...
      <div className="flex flex-col md:flex-row items-center bg-gradient-to-r from-green-300 to-lime-400">
      ...
      <div className="flex flex-col md:flex-row items-center bg-gradient-to-r from-amber-200 to-yellow-500">
        <div className="w-full md:w-1/2 p-4">
          <div className="rounded-lg overflow-hidden h-96 md:h-[30rem]">
            <video className="w-full h-full object-cover" autoPlay muted loop>
